...
const statusChart = new Chart(document.getElementById('cStatus'), {
  type: 'doughnut',
  data: {
    labels: [],
...
const weeklyChart = new Chart(document.getElementById('cWeekly'), {
  type: 'bar',
  data: {
    labels: [],
    datasets: [{
...
const priorityChart = new Chart(document.getElementById('cPriority'), {
  type: 'bar',
  data: {
    labels: [],
