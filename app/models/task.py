...
class Task(db.Model):
    ...
    assignee_role = db.Column(db.String(20), nullable=True)
    ...
    history     = db.relationship('TaskHistory', backref='task', lazy='dynamic', cascade='all, delete-orphan', order_by='TaskHistory.changed_at.desc()')
...
class TaskHistory(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'user_name': self.user.name, 'field': self.field,
